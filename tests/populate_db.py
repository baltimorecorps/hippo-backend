...
from tests.data.contact_data import CONTACTS_DATABASE, EMAILS_DATABASE
from tests.data.opportunity_data import (
    OPPS_DATABASE,
    OPP_APPS_DATABASE,
    RESUME_SNAPSHOTS
)
from tests.data.program_data import (
    PROGRAMS_DATABASE,
    PROGRAM_APPS_DATABASE
)
from tests.data.skill_data import SKILLS_NAMES
from tests.data.experience_data import (
    EXPERIENCES_DATABASE,
    ACHIEVEMENTS_DATABASE
)
from tests.data.profile_data import (
    ADDRESSES,
    PROGRAMS_COMPLETED,
    RACE,
    ROLES,
